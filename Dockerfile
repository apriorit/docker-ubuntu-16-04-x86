...
liblog4cpp5-dev libncurses5-dev libselinux1-dev wget libsqlite3-dev automake autoconf autotools-dev
RUN wget https://github.com/emcrisostomo/fswatch/releases/download/1.9.3/fswatch-1.9.3.tar.gz && tar xf fswatch-1.9.3.tar.gz && \
